    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamStudentAnswer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamStudentAnswer_Choices_ChoiceId",
                        column: x => x.ChoiceId,
                        principalTable: "Choices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamStudentAnswer_ExamQuestions_ExamQuestionId",
                        column: x => x.ExamQuestionId,
                        principalTable: "ExamQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamStudentAnswer_ExamStudents_ExamStudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamStudentAnswer_ChoiceId",
                table: "ExamStudentAnswer",
                column: "ChoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamStudentAnswer_ExamQuestionId",
                table: "ExamStudentAnswer",
                column: "ExamQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamStudentAnswer_ExamStudentId",
                table: "ExamStudentAnswer",
